  ...
  return (
    <div className="body_main">
      <div className="mdc-user-detail">
        <div className="header-mdc-user"></div>
        <div className="info">
          <div className="avatar-user" style={ sectionStyle }>
          </div>
          ...
          <div className="rank">Rank : Officer</div>
          <div className="btn-full-user-detail">full detail</div>
          <div className="bnt-logout">logout</div>
        </div>
      </div>
